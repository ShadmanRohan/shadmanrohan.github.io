...
2. Default CrossEntropy Loss already performs Softmax before calculating the loss. The target variable should contain a 1 dim array of ground truth indexes.
